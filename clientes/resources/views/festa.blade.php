                            ...
                            <form method="POST" action="/cadastro">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="estilos[]" value="pop" id="pop">
                                                <label class="form-check-label" for="pop">Pop</label>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="estilos[]" value="eletronico" id="eletronico">
                                                <label class="form-check-label" for="eletronico"><STRONG>BREGA</STRONG></label>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="estilos[]" value="mpb" id="mpb">
                                                <label class="form-check-label" for="mpb">MPB</label>
                                            </div>
                                        </div>
                                    </div>
